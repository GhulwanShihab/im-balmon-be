"""Export endpoints for loan documents and reports."""
...
@router.get("/loans/{loan_id}/document")
...
async def export_loan_report(
    ...
    """Export loan report PDF (Admin only)."""
...
async def export_overdue_report(
    ...
    """Export overdue loans report as PDF (Admin only)."""
...
@router.get("/device-usage-report")
async def export_device_usage_report(
    ...
    """Export device usage statistics report as PDF (Admin only)."""
...
async def export_monthly_summary(
    ...
    """Export monthly loan summary report as PDF (Admin only)."""
    from datetime import datetime
...
async def export_loan_statistics(
    ...
    """Export loan statistics as PDF (Admin only)."""
    from datetime import datetime
...
@router.get("/device-usage-statistics")
async def export_device_usage_statistics(
    ...
    """Export device usage statistics as PDF (Admin only)."""
